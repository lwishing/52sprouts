...
- (void)setHasPageControl:(BOOL)hasPageControl {
    ...
    if (hasPageControl) {
        ...
        [pageControl setPageIndicatorTintColor:[UIColor colorWithRed:(194/255.0) green:(194/255.0) blue:(194/255.0) alpha:1.0]];
        [pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:(53/255.0) green:(135/255.0) blue:(93/255.0) alpha:1.0]];
