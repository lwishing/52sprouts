...
- (id)initWithTitle:(NSString *)aTitle representedObject:(id)object font:(UIFont *)aFont {
	...
	if ((self = [super init])){
		...
		font = [aFont retain];
		tintColor = [[TIToken greenTintColor] retain];
...
- (void)setTintColor:(UIColor *)newTintColor {
	...
	if (!newTintColor) newTintColor = [TIToken greenTintColor];
...
//	return [UIColor colorWithRed:0.333 green:0.741 blue:0.235 alpha:1];
    return [UIColor colorWithRed:(55/255.0) green:(140/255.0) blue:(96/255.0) alpha:1.0];
}
